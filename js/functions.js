...
setText = (text, color = "dark") =>
  `<p class="font-${color} font-small text-center">${text}</p>`;
...
sortMe = (array, reverse = 1) =>
  array.sort(
    (a, b) =>
      reverse * (a.priority > b.priority ? 1 : a.priority < b.priority ? -1 : 0)
  );
